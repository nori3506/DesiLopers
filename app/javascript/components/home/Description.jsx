      ...
      <div class="home-desctiption">
        ...
        <div class="home-text">
          <p class="home-first-text-area">
            <span class="u-text-yellow">Desi</span>gners + Deve
            <span class="u-text-yellow">lopers</span> <br /> = <br />
            <span class="u-text-yellow stronger">"DesiLopers"</span>
          </p>
          <p class="home-explanation u-pt20">
            DesiLopers enables all Designers and Developers can search the best
            job offer.
          </p>
        </div>
      </div>
